...
<template>
    <div class="flex flex-col items-center w-full bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
        ...
        <div class="flex space-x-2 p-2 ml-auto">
            <Link :href="route('inforestaurante', { id: Restaurant.id })" :Restaurant="Restaurant">
            <button type="button"
                class="focus:outline-none text-white  bg-purple-600 hover:bg-purple-500 focus:ring-4 focus:ring-purple-600 font-medium rounded-lg text-sm px-3 py-2.5 dark:bg-purple-600 dark:hover:bg-purple-600 dark:focus:ring-purple-600">
                Informacion
            </button>
            </Link>
            <button type="button"
            ...
            <button type="button"
                class="focus:outline-none text-white bg-red-700 hover:bg-red-600 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
